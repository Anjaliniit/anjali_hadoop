	...
	public void map(LongWritable inkey,Text invalue,Context context) throws IOException, InterruptedException
	{
		...
		if(tot>=elg)
		{
			if(gender.equals("Male"))
				context.write(new Text("No of Male senior citizen is going to added after"+year+" years"),new IntWritable(1));
			else
				context.write(new Text("No of Female senior citizen is going to added after"+year+" years"),new IntWritable(1));
		}	
	}
}
